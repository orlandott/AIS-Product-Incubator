...
3. Save — the site goes live at `https://<user>.github.io/AIS-Product-Incubator/`.
...
- **Dates**: the site says "Applications opening soon" — update copy once cohort dates are fixed with LAISH.
